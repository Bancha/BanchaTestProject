<h1>Bancha Basic &amp; Pro: Controller Methods</h1>

<div class="middleOnly">
    Just type in a name and get the appropriate greeting for the current day time. <br />
    If you use the name <i>Judas</i> the server will return with an unsucessfull response.
</div>
<pre class="align-left">Bancha.getStub('Hello').getGreeting(time, username, function(result) {
